...
$(function() {
	$('#amount').change(function(event) {
		...
		var summ2 = Math.round((valS1 * radio) - parseInt($('#amount2').val()))+valS1;
		sliderCustom(summ2);
    ...
    $( "#slider-range-min" ).slider({
      ...
      slide: function( event, ui ) {
		...
		$('.in i').text(a11 +' p.');
		var radio = parseInt($(".margin input:radio:checked").val())/100;
		var summ2 = Math.round((valS1 * radio) - $("#slider-range-min2" ).slider( "value" ))+valS1;
		sliderCustom(summ2);
		sliderChangePrice(summ2);
      }
    });
	...
	$(".margin input:radio").change(function(){
		...
		var radio = parseInt($(".margin input:radio:checked").val())/100;
		var summ2 = Math.round(($("#slider-range-min" ).slider( "value" ) * radio) - $("#slider-range-min2" ).slider( "value" ))+$("#slider-range-min" ).slider( "value" );
		sliderCustom(summ2);
		sliderChangePrice(summ2);
	...
	$( "#slider-range-min2" ).slider({
      ...
      slide: function( event, ui ) {
		...
		var radio = parseInt($(".margin input:radio:checked").val())/100;
		var summ2 = Math.round(($("#slider-range-min" ).slider( "value" ) * radio) - ui.value)+$("#slider-range-min" ).slider( "value" );
